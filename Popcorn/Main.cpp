...
3.3 Анимация приза при разрушение (кирпич исчезает , анимация - остаётся)
...
6. Кирпич рекламы
6.1 Анимация фрагмента "рекламы", скрывающейся за кирпичом

Взаимодействия особых кирпичей 
1. Падающая буква - взаимодействует только с платформой 
2. Активные кирпичи - взаимодействуют только с шариком
...
2.1.4 Пуск шарика по пробелу и по таймауту   
...
2.3.2 Шкала пола
2.3.3 Взаимодействия пола с мячом
2.3.4 Отбытие мяча нижней гранью платформы


2.4 Л ("Лазер") 
2.4.1 Новое состояние платформы (+ анимация преобразования)
...
2.4.3.2 Обьекты лазерных лучей - анимация, перемещение и взаимодейтсвие с другими монстрами 
...
Попадание в кирпич
 ...
 3. Состояние гейтов (открыт, закрывается, открывается)

 Монстры 
 1. Список монстров (глаз, "черепаха", "сатурн", голова, "бубен", аквариум, зажигалка)
 2. Для каждого - сделать раскадровку 
 3. Перемещения, выбор направления + состояния (живой/пауза/исчезает)
 4. Взаимодействия с мячом и платформой
 5. Выход из гейта
 ...
 2. Состояние игры (заставка, анимация начала уровня, играем уровень, потеря жизни, переход на следующий уровень (нормальный и досрочный) , окончание игры)
